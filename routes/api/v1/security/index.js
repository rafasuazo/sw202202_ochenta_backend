...
const auth = require('../../../../routes/api/v1/middlewares/auth');
const Usuario = require('../../../../libs/usuarios');
const UsuarioDao = require('../../../../dao/mongodb/models/UsuarioDao');
const validation = require('../../../../routes/api/v1/middlewares/auth');
...
// estas son para el envío de email
router.post('/recoverPass', validation.ValidateMail, auth.RecoverPass);
router.put('/checkPin', validation.ValidatePin, auth.CheckPin);
